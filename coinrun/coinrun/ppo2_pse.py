...
def collect_data(model,env,nsteps):
...
def learn(*, policy, env, eval_env, nsteps, total_timesteps, ent_coef, lr,
    ...
    for update in range(start_update+1, nupdates+1):
        ...
        """
        mdp_1,mdp_2 = np.random.choice(range(Config.NUM_LEVELS),size=2,replace=False)
        # import ipdb;ipdb.set_trace()
        ...
        mb_obs_1, mb_actions_1, mb_rewards_1 = collect_data(random_policy,venv_eval_1,nsteps=256)
        mb_obs_2, mb_actions_2, mb_rewards_2 = collect_data(random_policy,venv_eval_2,nsteps=256)
