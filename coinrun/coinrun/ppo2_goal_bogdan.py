...
class Model(object):
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
        ...
        # tf.linalg.matmul(tf.linalg.normalize(train_model.u_t, axis=1, ord='euclidean')[0]
        # tf.linalg.normalize(train_model.protos, axis=1, ord='euclidean')[0]
        p_t = tf.nn.log_softmax(train_model.u_t, train_model.protos ) / Config.TEMP, axis=1)
